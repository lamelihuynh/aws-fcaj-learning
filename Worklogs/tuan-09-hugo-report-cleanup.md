...
| --- | --- | --- | --- | --- |
| Thứ 2 | 10/08/2026 | Rà soát cấu trúc Hugo, section weight, song ngữ và đường dẫn Worklog 9 tuần. | [Module 9](../First%20Cloud%20AI%20Journey/Module%209/module-09-ly-thuyet-architecture-devsecops-report.md) | Tài liệu nội bộ trong repo |
| Thứ 3 | 11/08/2026 | Tích hợp Worklog, Proposal, Blogs, Events, Workshop, Self-evaluation, Feedback và References. | [Lab 09 Architecture Checklist](../First%20Cloud%20AI%20Journey/Module%209/Hands-on%20Labs/lab-09-devsecops-architecture-checklist.md) | [000017 - CI/CD với ECS Container](https://000017.awsstudygroup.com/vi/) |
| Thứ 4 | 12/08/2026 | Chuẩn hóa thuật ngữ Anh/Việt cho VPC, IAM, ECR, ECS Fargate, Lambda, CloudWatch, GitOps và least privilege. | [README repo](../README.md) | Tài liệu nội bộ trong repo |
